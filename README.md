...
```
git clone https://github.com/YASHN24/DeepSORT-Object-Tracking-Using-YOLO8.git
```
...
- For yolov8 object detection + Tracking + Vehicle Counting
```
python predict1.py model=yolov8l.pt source="test3.mp4" show=True
```
# DeepSort_ObjectTracking_YOLOv8
# DeepSort_ObjectTracking_YOLOv8
# DeepSort_ObjectTracking_YOLOv8
# DeepSort_ObjectTracking_YOLOv8
